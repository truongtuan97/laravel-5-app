  ...
  <div class="main-menu menu-fixed menu-light menu-shadow menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item">
          <a href="{{ route('management.chkm.list') }}"><i class="feather icon-user"></i><span class="menu-title"
              data-i18n="Users">Cấu hình khuyến mãi</span></a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('management.thongkenap.list') }}"><i class="feather icon-user"></i><span class="menu-title"
              data-i18n="Users">Thống kê nạp</span></a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('management.lognaptien.list') }}"><i class="feather icon-user"></i><span class="menu-title"
              data-i18n="Users">Log nạp tiển</span></a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('management.logquanlytaikhoan.list') }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Users">Log quản lý tài khoản</span></a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('management.lichsuruttien.list') }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Users">Lịch sử rút tiền</span>
          </a>
        </li>
      </ul>
    </div>
