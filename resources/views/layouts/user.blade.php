  ...
  <div class="main-menu menu-fixed menu-light menu-shadow menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item">
          <a href="https://vltk.com.vn">
            <i class="feather icon-home"></i>
            <span class="menu-title" data-i18n="Dashboard">Trang chủ</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="https://facebook.com/volamsonhaxatac">
            <i class="feather icon-facebook"></i>
            <span class="menu-title" data-i18n="Dashboard">Fanpage</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('users.edit', Auth::user()->id) }}">
            ...
            <span class="menu-title" data-i18n="Dashboard">Đổi thông tin</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('password_c1.users.edit', Auth::user()->cAccName) }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Dashboard">Đổi mật khẩu cấp 1</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('password_c2.users.edit', Auth::user()->cAccName) }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Dashboard">Đổi mật khẩu cấp 2</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('email.users.edit', Auth::user()->cAccName) }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Dashboard">Đổi email</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('phone.users.edit', Auth::user()->cAccName) }}">
            <i class="feather icon-user"></i>
            <span class="menu-title" data-i18n="Dashboard">Đổi số điện thoại</span>
            <span class="badge badge badge-primary badge-pill float-right mr-2"></span>
          </a>
        </li>
        <li class=" nav-item">
