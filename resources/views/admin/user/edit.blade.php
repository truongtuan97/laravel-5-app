      ...
      <div class="card-body">
        ...
        <form method="post" action="{{route('management.user.update', $user)}}">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              <input id="password1" type="password" class="form-control @error('password1') is-invalid @enderror"
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              <input id="password1-confirm" type="password" class="form-control" name="password1_confirmation"
